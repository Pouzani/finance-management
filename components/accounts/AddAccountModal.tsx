      ...
      >
        <div className="p-6">
          <div className="flex items-center justify-between mb-6">
            <div>
              <EyebrowLabel className="mb-1 block">{isEdit ? t('modalEditEyebrow') : t('modalNewEyebrow')}</EyebrowLabel>
              <h2
                style={{
              ...
              >
                {isEdit ? t('modalEditTitle') : t('modalNewTitle')}
              </h2>
            </div>
            <Button
              variant="ghost"
          ...
          <div className="mb-4">
            <EyebrowLabel className="mb-2 block">{t('accountName')}</EyebrowLabel>
            <Input
              type="text"
              value={form.name}
          ...
          <div className="mb-6">
            <EyebrowLabel className="mb-2 block">
              {isEdit ? t('currentBalance') : t('initialBalance')}
            </EyebrowLabel>
            <Input
              type="text"
              value={form.balance}
          ...
          >
            {saving
              ? isEdit ? t('editing') : t('saving')
              : isEdit ? t('saveAccountEdit') : t('saveAccount')}
          </Button>
        </div>
      </div>
    </div>
